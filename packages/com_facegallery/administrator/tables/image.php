...
// Image Table class
class FacegalleryTableImage extends JTable
{
    var $id = null;
    var $image_name=null;
    ...
    var $medium_image = null;   
    var $watermark_image = null;
    var $slider_image = null;
    var $state = null;
    var $access = null;
    var $language = null;
    var $upload_option = null;
    var $featured = null;
    var $created_on = null;
    var $updated_on = null;
    ...
    {
        parent::__construct('#__facegallery_images', 'id', $db);
    ...
    {
        // Set Image name
		$this->image_name = htmlspecialchars_decode($this->image_name, ENT_QUOTES);
